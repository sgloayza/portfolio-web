  ...
  es: {
    ...
    projects: {
      ...
      simulator: {
        ...
        btnBackPortfolio: '← Volver al Portafolio',
        viewGithubRepo: 'Repositorio en GitHub',
        ...
        guideBanner: '🧪 Guía Rápida: Selecciona uno de los 4 escenarios de prueba abajo y presiona los botones paso a paso para ver los resultados en vivo:',
        cdc: {
          ...
          scenarioDesc: '🎯 Objetivo: Demostrar la regla de retención legal inmutable. Aunque borres los registros operativos en caliente, la réplica histórica de Kafka preserva el 100% de la telemetría.',
          ...
          btnInsert: '1️⃣ Paso 1: Enviar Telemetría de Sensor',
          btnDelete: '2️⃣ Paso 2: Simular Borrado Accidental (deleteMany)',
          btnReset: '⟲ Reiniciar Datos',
        ...
        mutex: {
          ...
          scenarioDesc: '🎯 Objetivo: Presiona el Paso 1 para iniciar un despliegue y, de inmediato, el Paso 2 para ver cómo Ansible rechaza la colisión y protege la placa.',
          ...
          btnRunTask1: '1️⃣ Paso 1: Disparar Tarea 1 (Aprovisionar Nginx)',
          btnRunTask2: '2️⃣ Paso 2: Intentar Tarea 2 (Simultánea)',
        ...
        observability: {
          ...
          scenarioDesc: '🎯 Objetivo: Simula un fallo de hardware (fuga de memoria al 89%) y luego ejecuta la auto-remediación para observar la estabilización automática.',
          ...
          btnStress: '1️⃣ Paso 1: Fuga de RAM (Estrés 89%)',
          btnRemediate: '2️⃣ Paso 2: Auto-Remediación Ansible',
          btnMetricsStream: '3️⃣ Paso 3: Explorar Endpoint /metrics',
          btnMetricsHide: '3️⃣ Ocultar Stream /metrics',
        ...
        terminal: {
          ...
          scenarioDesc: '🎯 Objetivo: Haz clic en cualquiera de los dos scripts de infraestructura para ver la salida real coloreada generada en la terminal:',
          btnVerify: '▶️ 1. Test de Diagnóstico del Clúster (verify_cluster.sh)',
          btnAnsible: '▶️ 2. Playbook de Aprovisionamiento (demo_ansible_live.sh)',
  ...
  en: {
    ...
    projects: {
      ...
      simulator: {
        ...
        viewGithubRepo: 'GitHub Repository',
        navTopology: 'CDC Pipeline & Kafka',
        navMutex: 'Mutex Control (Anti-Collision)',
        navObservability: 'Prometheus & Watchdog',
        navTerminal: 'Ansible Terminal',
        guideBanner: '🧪 Quick Test Guide: Choose one of the 4 numbered test scenarios below and click the step-by-step buttons to see live results:',
        cdc: {
          ...
          scenarioDesc: '🎯 Objective: Demonstrate immutable statutory retention. Even if hot production records are wiped, the Kafka historical sink retains 100% of telemetry.',
          ...
          btnInsert: '1️⃣ Step 1: Emit Sensor Telemetry',
          btnDelete: '2️⃣ Step 2: Accidental Purge (deleteMany)',
          btnReset: '⟲ Reset Test Data',
          docsCount: 'Documents:',
        ...
        mutex: {
          ...
          scenarioDesc: '🎯 Objective: Click Step 1 to begin a role deployment, then immediately click Step 2 to witness how Ansible rejects the collision and protects the hardware.',
          ...
          btnRunTask1: '1️⃣ Step 1: Dispatch Task 1 (Provision Nginx)',
          btnRunTask2: '2️⃣ Step 2: Attempt Task 2 (Concurrent)',
        ...
        observability: {
          ...
          scenarioDesc: '🎯 Objective: Simulate a hardware fault (RAM leak up to 89%), then trigger self-healing to observe automated system stabilization.',
          ...
          btnStress: '1️⃣ Step 1: RAM Leak (Stress 89%)',
          btnRemediate: '2️⃣ Step 2: Ansible Self-Healing',
          btnMetricsStream: '3️⃣ Step 3: Inspect /metrics Endpoint',
          btnMetricsHide: '3️⃣ Hide /metrics Stream',
        ...
        terminal: {
          ...
          scenarioDesc: '🎯 Objective: Click either infrastructure script to inspect authentic, colored output generated in the live terminal:',
          btnVerify: '▶️ 1. Cluster Health Diagnostic (verify_cluster.sh)',
          btnAnsible: '▶️ 2. Provisioning Playbook (demo_ansible_live.sh)',
          btnClean: '⟲ Clear Console'
        }
      },
      items: [
        {
